...
export function serviceProviderInProcessOrders(
  orderType: OrderType,
  providerId: string,
  orderId?: string
) {
  let dbNode: string = `/${pluralizeOrderType(
    orderType
  )}/inProcessOrders/${providerId}`;
...
export function serviceProviderPastOrders(
  orderType: OrderType,
  providerId: string,
  orderId?: string
) {
...
export function serviceProviderDetails(
  ...
  return serviceProviderInfo(orderType, providerId).child("details");
}
...
export function serviceProviderPaymentInfo(
  ...
  return serviceProviderInfo(orderType, providerId).child(
    "details/paymentInfo"
  );
}

export function serviceProviderStripeId(
  orderType: OrderType,
  providerId: string
) {
