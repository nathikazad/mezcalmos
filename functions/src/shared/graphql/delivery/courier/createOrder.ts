...
export async function createNewCourierOrder(
    ...
    let params: any = {
        ...
        "from_location_gps": undefined
    }
    if (courierRequest.fromLocationGps != null)
        params.from_location_gps = {
            "type": "Point",
            ...
            object: {
                ...
                delivery_order: {
                    data: {
                        ...
                        // service_provider_id: courierRequest.companyId,
    ...
    return {
        ...
        deliveryOrder: {
            ...
            // serviceProviderId: courierRequest.companyId,
