...
export async function updateDeliveryOrderCompany(
...
export async function updateDeliveryChangePriceRequest(
...
export async function setLockTime(deliveryOrderId: number) {
  ...
  if (
    response.update_delivery_order == null ||
    response.update_delivery_order.affected_rows == 0
  ) {
