  ...
  try {
    ...
    const customClaims = {
      "https://hasura.io/jwt/claims": {
        ...
        "x-hasura-allowed-roles": ["anonymous", "restaurant_operator", "customer", "mez_admin", "deliverer", "delivery_operator","delivery_driver","laundry_operator"], // add admin role for admin users
