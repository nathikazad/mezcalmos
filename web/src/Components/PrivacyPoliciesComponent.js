...
<div className="font-medium leading-tight text-4xl mt-0 mb-2">Interpretation and Definitions</div>
...
<ul>
    ...
    <li>
        <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any
            electronic device, named Mezcalmos</p>
    </li>
    <li>
        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or
            "Our" in this Agreement) refers to Mezcalmos Inc, Infraganti Ave #202, Luz De Luna, Bungalos no.6,
            Piso
            3, Lazero.</p>
    </li>
    <li>
...
<div className="font-medium leading-tight text-4xl mt-0 mb-2">Collecting and Using Your Personal Data</div>
...
<div className="font-medium leading-tight text-4xl mt-0 mb-2">Links to Other Websites</div>
<p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You
    will be directed to that third party's site. We strongly advise You to review the Privacy Policy of every site You
    visit.</p>
<p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third
    party sites or services.</p>
<div className="font-medium leading-tight text-4xl mt-0 mb-2">Changes to this Privacy Policy</div>
...
<div className="font-medium leading-tight text-4xl mt-0 mb-2">Contact Us</div>
...
export default PrivacyPoliciesComponent;
