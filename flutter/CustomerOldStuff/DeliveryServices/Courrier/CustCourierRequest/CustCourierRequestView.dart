...
import 'package:mezcalmos/CustomerApp/pages/DeliveryServices/Courrier/CustCourierRequest/controllers/CustCourierRequestController.dart';
...
class CustCourierRequestView extends StatefulWidget {
  static Future<void> navigate() {
    return MezRouter.toPath(CourierRoutes.kRequestCourierViewRoute);
  }

  const CustCourierRequestView({super.key});

  @override
  State<CustCourierRequestView> createState() => _CustCourierRequestViewState();
}

class _CustCourierRequestViewState extends State<CustCourierRequestView> {
  CustCourierRequestController viewController = CustCourierRequestController();
  @override
  void initState() {
    viewController.init();
