...
class _UnauthorizedScreenState extends State<UnauthorizedScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _animeCtrl = new AnimationController(duration: const Duration(seconds: 2), vsync: this)..repeat();
...
// Color.fromARGB(255, 198, 90, 252),
    ...
    return Center(
      child: Flex(
        ...
        [
          Container(
          child: Icon(Icons.block_outlined, color: Color.fromARGB(150, 198, 90, 252), size: getSizeRelativeToScreen(80, Get.height, Get.width),),
