...
import 'package:mezcalmos/RestaurantApp/pages/FeedView/components/RsFeedCardPost.dart';
import 'package:mezcalmos/RestaurantApp/pages/FeedView/controllers/ServiceFeedViewController.dart';
...
class RsFeedView extends StatelessWidget {
  final bool asTab;
  RsFeedView({super.key, this.asTab = false});

  static Future<void> navigate() {
    return MezRouter.toPath(CustomerRoutes.customerOrdersRoute);
  }

  final RsFeedViewController _viewController = RsFeedViewController.init();
