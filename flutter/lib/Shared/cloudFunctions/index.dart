...
class CloudFunctions {
  ...
  static Future<ServerResponse> otp_sendOTPForLogin(
      {required String language, required String phoneNumber}) {
    return callCloudFunction(
  ...
  static Future<ServerResponse> stripe_removeCard({required String cardId}) {
    return callCloudFunction(
  ...
  static Future<ServerResponse> stripe_updateServiceProvider(
      {required num serviceProviderId, required OrderType orderType}) {
    return callCloudFunction(
  ...
  static Future<ServerResponse> agora_callChatUser(
      {required num chatId, required ParticipantType callerParticipantType}) {
    return callCloudFunction(
  ...
  static Future<ServerResponse> restaurant2_addRestaurantOperator(
      {required num restaurantId, NotificationInfo? notificationInfo}) {
    return callCloudFunction(
  ...
  static Future<ServerResponse> restaurant2_authorizeRestaurantOperator(
      {required num newOperatorId, required bool approved}) {
    return callCloudFunction(
  ...
  static Future<ServerResponse> restaurant2_addRestaurantDriver(
      {required num deliveryCompanyId, NotificationInfo? notificationInfo}) {
    return callCloudFunction(
  ...
  static Future<ServerResponse> restaurant2_authorizeRestaurantDriver(
      {required num deliveryDriverId, required bool approved}) {
    return callCloudFunction(
