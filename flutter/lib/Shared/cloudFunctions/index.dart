...
class CloudFunctions {
  ...
  static Future<ChangeRestaurantStatusResponse>
      restaurant2_orderPickedUpByCustomer({required num orderId}) async {
    return ChangeRestaurantStatusResponse.fromFirebaseFormattedJson(
        await callCloudFunction(
  ...
  static Future<ChangeRestaurantStatusResponse>
      restaurant2_cancelOrderFromAdmin({required num orderId}) async {
    return ChangeRestaurantStatusResponse.fromFirebaseFormattedJson(
        await callCloudFunction(
  ...
  static Future<CancelRestaurantOrderResponse>
      restaurant2_cancelOrderFromCustomer({required num orderId}) async {
