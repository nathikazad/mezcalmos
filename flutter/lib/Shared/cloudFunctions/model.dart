...
class BusinessItemDetails {
  ...
  BusinessItemDetails({
    required this.id, required this.name, this.description, this.position, required this.businessId, required this.available, this.image, required this.cost, this.additionalParameters});
Map<String, dynamic> toFirebaseFormattedJson() {
    return <String, dynamic>{
      "id": id,
      "name": name,
