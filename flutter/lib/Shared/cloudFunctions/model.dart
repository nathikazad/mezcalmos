...
class CallUserResponse {
  ...
  CallUserResponse(this.uid, this.token, this.expirationTime,
      this.participantType, this.notificationInfo);
  Map<String, dynamic> toFirebaseFormattedJson() {
    return <String, dynamic>{
      "uid": uid,
      "token": token,
  ...
  factory CallUserResponse.fromFirebaseFormattedJson(json) {
    return CallUserResponse(json["uid"], json["token"], json["expirationTime"],
        json["participantType"], json["notificationInfo"]);
  }
}
...
class DeliveryDetails {
  ...
  DeliveryDetails(this.minimumCost, this.costPerKm, this.radius,
      this.freeDeliveryMinimumCost, this.freeDeliveryKmRange);
  Map<String, dynamic> toFirebaseFormattedJson() {
    return <String, dynamic>{
