...
class ReqDeliveryResponse {
  ...
  factory ReqDeliveryResponse.fromFirebaseFormattedJson(json) {
    return ReqDeliveryResponse(json["success"],
        json["error"]?.toString().toReqDeliveryError(), json["unhandledError"]);
  }
}
...
class CounterOfferResponse {
  ...
  factory CounterOfferResponse.fromFirebaseFormattedJson(json) {
    return CounterOfferResponse(
        json["success"],
        json["error"]?.toString().toCounterOfferError(),
        json["unhandledError"]);
  }
}
...
class DeliveryDriver {
  ...
  DeliveryDriver(
      ...
      required this.deliveryCompanyType,
  ...
  CounterOfferStatus toCounterOfferStatus() {
    return CounterOfferStatus.values.firstWhere(
        (CounterOfferStatus counterOfferStatus) =>
            counterOfferStatus.toFirebaseFormatString().toLowerCase() ==
            toLowerCase());
  }
}
...
extension ParseStringToOfferType on String {
  OfferType toOfferType() {
    return OfferType.values.firstWhere((OfferType offerType) =>
...
extension ParseStringToOfferStatus on String {
  OfferStatus toOfferStatus() {
    return OfferStatus.values.firstWhere((OfferStatus offerStatus) =>
...
class Discount {
  ...
  num discountAmount;
  Discount({required this.discountType, required this.discountAmount});
  Map<String, dynamic> toFirebaseFormattedJson() {
    return <String, dynamic>{
      "discountType": discountType,
...
enum ReqDeliveryError {
  ...
  OrderCreationError,
  NoDeliveryChatWithStoreId,
  NoDeliveryCompanyFound,
  DeliveryCompaniesHaveNoDrivers
}
  ...
  ReqDeliveryError toReqDeliveryError() {
    return ReqDeliveryError.values.firstWhere(
        (ReqDeliveryError reqDeliveryError) =>
            reqDeliveryError.toFirebaseFormatString().toLowerCase() ==
            toLowerCase());
  }
}
  ...
  CounterOfferError toCounterOfferError() {
    return CounterOfferError.values.firstWhere(
        (CounterOfferError counterOfferError) =>
            counterOfferError.toFirebaseFormatString().toLowerCase() ==
            toLowerCase());
  }
}
