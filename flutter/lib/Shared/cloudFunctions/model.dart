...
class OfferDetails {
  ...
  bool? couponReusable;
  OfferDetails({
    required this.offerForOrder, this.offerForItems, required this.discountType, required this.discountValue, this.minimumOrderAmount, this.items, this.categories, this.nameIds, this.offeringTypes, this.validityRangeStart, this.validityRangeEnd, required this.weeklyRepeat, this.couponReusable});
Map<String, dynamic> toFirebaseFormattedJson() {
    return <String, dynamic>{
