class MarkMessagesResponse {
  ...
  factory MarkMessagesResponse.fromFirebaseFormattedJson(json) {
    return MarkMessagesResponse(
        json["success"],
        json["error"]?.toString().toMarkMessagesError(),
        json["unhandledError"]);
  }
}
...
class MarkMessagesAsCancelledResponse {
  ...
  MarkMessagesError? error;
  String? unhandledError;
  MarkMessagesAsCancelledResponse(
  ...
  factory MarkMessagesAsCancelledResponse.fromFirebaseFormattedJson(json) {
    return MarkMessagesAsCancelledResponse(
        json["success"],
        json["error"]?.toString().toMarkMessagesError(),
        json["unhandledError"]);
  }
  ...
  MarkMessagesError toMarkMessagesError() {
    return MarkMessagesError.values.firstWhere(
        (MarkMessagesError markMessagesError) =>
            markMessagesError.toFirebaseFormatString().toLowerCase() ==
            toLowerCase());
  }
}
