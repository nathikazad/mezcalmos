...
enum DeliveryType { Pickup, Delivery, SitIn }
...
class NewCheckoutResponse {
  ...
  String? unhandledError;
  num? orderId;
  NewCheckoutResponse(this.success, this.error, this.unhandledError, this.orderId);
Map<String, dynamic> toFirebaseFormattedJson() {
    return <String, dynamic>{
      "success": success,
      "error": error,
...
factory NewCheckoutResponse.fromFirebaseFormattedJson(json) { 
   return NewCheckoutResponse(json["success"], json["error"]?.toString().toNewCheckoutResponseError(), json["unhandledError"], json["orderId"]);
  }
}
...
class CompleteRestaurantOrderResponse {
  ...
  String? unhandledError;
  CompleteRestaurantOrderResponse(this.success, this.error, this.unhandledError);
Map<String, dynamic> toFirebaseFormattedJson() {
    return <String, dynamic>{
      "success": success,
      "error": error,
...
factory CompleteRestaurantOrderResponse.fromFirebaseFormattedJson(json) { 
   return CompleteRestaurantOrderResponse(json["success"], json["error"]?.toString().toCompleteOrderError(), json["unhandledError"]);
  }
}
...
class ImageMessage {
  ...
  String? caption;
  ImageMessage({
    required this.id, required this.url, required this.mime_type, required this.sha256, this.caption});
Map<String, dynamic> toFirebaseFormattedJson() {
    return <String, dynamic>{
      "id": id,
      "url": url,
...
class Contact {
  ...
  String wa_id;
  Contact({
    required this.profile, required this.wa_id});
Map<String, dynamic> toFirebaseFormattedJson() {
    return <String, dynamic>{
      "profile": profile,
      "wa_id": wa_id,
...
class ChangeValue {
  ...
  Metadata metadata;
  ChangeValue({
    required this.contacts, required this.messages, required this.messaging_product, required this.metadata});
Map<String, dynamic> toFirebaseFormattedJson() {
    return <String, dynamic>{
      "contacts": contacts,
      "messages": messages,
...
class Metadata {
  ...
  Metadata({
    required this.display_phone_number, required this.phone_number_id});
Map<String, dynamic> toFirebaseFormattedJson() {
    return <String, dynamic>{
...
class Entry {
  ...
  String id;
  Entry({
    required this.changes, required this.id});
Map<String, dynamic> toFirebaseFormattedJson() {
    return <String, dynamic>{
      "changes": changes,
      "id": id,
...
enum ItemTag { Vegan, VeganPossible, Vegetarian, GlutenFree, GlutenFreePossible }
...
extension ParseStringToItemTag on String {
  ItemTag toItemTag() {
    return ItemTag.values.firstWhere(
        (ItemTag itemTag) =>
...
enum RestaurantOrderStatus { InProcess, OrderReceived, Preparing, Ready, OnTheWay, Delivered, CancelledByAdmin, CancelledByCustomer }
...
enum NewCheckoutResponseError { UnhandledError, RestaurantClosed, CartEmpty, RestaurantNotApproved, NotAcceptingDeliveryOrders, RestaurantNotFound, CartNotFound, CustomerNotFound, RestaurantIdMismatch, OrderCreationError, DeliveryCompanyOperatorsNotFound, ServiceProviderDetailsNotFound, NoStripeAccountOfServiceProvider, UpdateOrderStripeError }
  ...
  NewCheckoutResponseError toNewCheckoutResponseError() {
    return NewCheckoutResponseError.values.firstWhere(
        (NewCheckoutResponseError newCheckoutResponseError) =>
            newCheckoutResponseError.toFirebaseFormatString().toLowerCase() == toLowerCase());
  }
}


enum CompleteOrderError { UnhandledError, OrderNotFound, RestaurantNotfound, IncorrectOrderId, OrderNotInProcess, ServiceProviderDetailsNotFound, UnauthorizedAccess }
  ...
  CompleteOrderError toCompleteOrderError() {
    return CompleteOrderError.values.firstWhere(
        (CompleteOrderError completeOrderError) =>
            completeOrderError.toFirebaseFormatString().toLowerCase() == toLowerCase());
  }
}
