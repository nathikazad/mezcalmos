...
class OpenHours {
  ...
  List<num> from;
  List<num> to;
  OpenHours({required this.isOpen, required this.from, required this.to});
  Map<String, dynamic> toFirebaseFormattedJson() {
    return <String, dynamic>{
      "isOpen": isOpen,
      "from": from,
...
class Service {
  ...
  BusinessItemDetails details;
  Service({this.id, required this.category1, required this.details});
  Map<String, dynamic> toFirebaseFormattedJson() {
    return <String, dynamic>{
      "id": id,
      "category1": category1,
...
extension ParseStringToHomeType on String {
  HomeType toHomeType() {
    return HomeType.values.firstWhere((HomeType homeType) =>
