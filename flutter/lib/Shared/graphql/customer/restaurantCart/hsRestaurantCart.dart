...
import 'package:mezcalmos/Shared/graphql/customer/restaurantCart/__generated/restaurant_cart.graphql.dart';
  ...
  if (cartData != null) {
    final Cart cart = Cart(
        restaurant: cartData.restaurant != null
            ? Restaurant(
                onlineOrdering: cartData.restaurant!.details!.online_ordering,
                ...
                deliveryCost: (cartData.restaurant?.delivery_details == null)
                    ...
                    : DeliveryCost(
                        ...
                        deliveryAvailable: cartData
                            .restaurant!.delivery_details.delivery_available,
                        pickupAvailable: cartData
                            .restaurant!.delivery_details.customer_pickup,
                        //sitInAvailable: cartData.restaurant!.sitin_available,
                        sitInAvailable: true,
