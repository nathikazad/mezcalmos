...
class Variables$Subscription$listen_or_courier_order_prices {
  factory Variables$Subscription$listen_or_courier_order_prices(
          {required int orderId}) =>
      Variables$Subscription$listen_or_courier_order_prices._({
        r'orderId': orderId,
      });

  Variables$Subscription$listen_or_courier_order_prices._(this._$data);

  factory Variables$Subscription$listen_or_courier_order_prices.fromJson(
      Map<String, dynamic> data) {
    final result$data = <String, dynamic>{};
    final l$orderId = data['orderId'];
    result$data['orderId'] = (l$orderId as int);
    return Variables$Subscription$listen_or_courier_order_prices._(result$data);
  }
  ...
  CopyWith$Variables$Subscription$listen_or_courier_order_prices<
          Variables$Subscription$listen_or_courier_order_prices>
      get copyWith =>
          CopyWith$Variables$Subscription$listen_or_courier_order_prices(
            this,
            (i) => i,
  ...
  bool operator ==(Object other) {
    ...
    if (!(other is Variables$Subscription$listen_or_courier_order_prices) ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$orderId = orderId;
...
abstract class CopyWith$Variables$Subscription$listen_or_courier_order_prices<
    TRes> {
  factory CopyWith$Variables$Subscription$listen_or_courier_order_prices(
    Variables$Subscription$listen_or_courier_order_prices instance,
    TRes Function(Variables$Subscription$listen_or_courier_order_prices) then,
  ) = _CopyWithImpl$Variables$Subscription$listen_or_courier_order_prices;

  factory CopyWith$Variables$Subscription$listen_or_courier_order_prices.stub(
          TRes res) =
      _CopyWithStubImpl$Variables$Subscription$listen_or_courier_order_prices;

  TRes call({int? orderId});
}

class _CopyWithImpl$Variables$Subscription$listen_or_courier_order_prices<TRes>
    implements
        CopyWith$Variables$Subscription$listen_or_courier_order_prices<TRes> {
  _CopyWithImpl$Variables$Subscription$listen_or_courier_order_prices(
    this._instance,
    this._then,
  );

  final Variables$Subscription$listen_or_courier_order_prices _instance;

  final TRes Function(Variables$Subscription$listen_or_courier_order_prices)
      _then;

  static const _undefined = {};

  TRes call({Object? orderId = _undefined}) =>
      _then(Variables$Subscription$listen_or_courier_order_prices._({
        ..._instance._$data,
        if (orderId != _undefined && orderId != null)
          'orderId': (orderId as int),
      }));
...
class _CopyWithStubImpl$Variables$Subscription$listen_or_courier_order_prices<
        TRes>
    implements
        CopyWith$Variables$Subscription$listen_or_courier_order_prices<TRes> {
  _CopyWithStubImpl$Variables$Subscription$listen_or_courier_order_prices(
...
class Subscription$listen_or_courier_order_prices {
  Subscription$listen_or_courier_order_prices({
    required this.delivery_courier_order,
    required this.$__typename,
  });

  factory Subscription$listen_or_courier_order_prices.fromJson(
      Map<String, dynamic> json) {
    final l$delivery_courier_order = json['delivery_courier_order'];
    final l$$__typename = json['__typename'];
    return Subscription$listen_or_courier_order_prices(
      delivery_courier_order: (l$delivery_courier_order as List<dynamic>)
          .map((e) =>
              Subscription$listen_or_courier_order_prices$delivery_courier_order
                  .fromJson((e as Map<String, dynamic>)))
          .toList(),
      $__typename: ((l$$__typename ?? "none") as String),
    );
  ...
  final List<Subscription$listen_or_courier_order_prices$delivery_courier_order>
  ...
  bool operator ==(Object other) {
    ...
    if (!(other is Subscription$listen_or_courier_order_prices) ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$delivery_courier_order = delivery_courier_order;
...
extension UtilityExtension$Subscription$listen_or_courier_order_prices
    on Subscription$listen_or_courier_order_prices {
  CopyWith$Subscription$listen_or_courier_order_prices<
          Subscription$listen_or_courier_order_prices>
      get copyWith => CopyWith$Subscription$listen_or_courier_order_prices(
            this,
            (i) => i,
          );
}

abstract class CopyWith$Subscription$listen_or_courier_order_prices<TRes> {
  factory CopyWith$Subscription$listen_or_courier_order_prices(
    Subscription$listen_or_courier_order_prices instance,
    TRes Function(Subscription$listen_or_courier_order_prices) then,
  ) = _CopyWithImpl$Subscription$listen_or_courier_order_prices;

  factory CopyWith$Subscription$listen_or_courier_order_prices.stub(TRes res) =
      _CopyWithStubImpl$Subscription$listen_or_courier_order_prices;

  TRes call({
    List<Subscription$listen_or_courier_order_prices$delivery_courier_order>?
        delivery_courier_order,
    String? $__typename,
  });
  TRes delivery_courier_order(
      Iterable<Subscription$listen_or_courier_order_prices$delivery_courier_order> Function(
              Iterable<
                  CopyWith$Subscription$listen_or_courier_order_prices$delivery_courier_order<
                      Subscription$listen_or_courier_order_prices$delivery_courier_order>>)
          _fn);
}

class _CopyWithImpl$Subscription$listen_or_courier_order_prices<TRes>
    implements CopyWith$Subscription$listen_or_courier_order_prices<TRes> {
  _CopyWithImpl$Subscription$listen_or_courier_order_prices(
    this._instance,
    this._then,
  );

  final Subscription$listen_or_courier_order_prices _instance;

  final TRes Function(Subscription$listen_or_courier_order_prices) _then;
  ...
  TRes call({
    ...
    Object? $__typename = _undefined,
      ...
      _then(Subscription$listen_or_courier_order_prices(
...
class _CopyWithStubImpl$Subscription$listen_or_courier_order_prices<TRes>
    implements CopyWith$Subscription$listen_or_courier_order_prices<TRes> {
  _CopyWithStubImpl$Subscription$listen_or_courier_order_prices(this._res);
...
const documentNodeSubscriptionlisten_or_courier_order_prices =
    DocumentNode(definitions: [
  OperationDefinitionNode(
    type: OperationType.subscription,
    name: NameNode(value: 'listen_or_courier_order_prices'),
    variableDefinitions: [
      VariableDefinitionNode(
        variable: VariableNode(name: NameNode(value: 'orderId')),
        type: NamedTypeNode(
...
Subscription$listen_or_courier_order_prices
    _parserFn$Subscription$listen_or_courier_order_prices(
            Map<String, dynamic> data) =>
        Subscription$listen_or_courier_order_prices.fromJson(data);

class Options$Subscription$listen_or_courier_order_prices extends graphql
    .SubscriptionOptions<Subscription$listen_or_courier_order_prices> {
  Options$Subscription$listen_or_courier_order_prices({
    String? operationName,
    required Variables$Subscription$listen_or_courier_order_prices variables,
    graphql.FetchPolicy? fetchPolicy,
    graphql.ErrorPolicy? errorPolicy,
    graphql.CacheRereadPolicy? cacheRereadPolicy,
    Object? optimisticResult,
    graphql.Context? context,
          ...
          optimisticResult: optimisticResult,
          context: context,
          document: documentNodeSubscriptionlisten_or_courier_order_prices,
          parserFn: _parserFn$Subscription$listen_or_courier_order_prices,
        );
}

class WatchOptions$Subscription$listen_or_courier_order_prices extends graphql
    .WatchQueryOptions<Subscription$listen_or_courier_order_prices> {
  WatchOptions$Subscription$listen_or_courier_order_prices({
    String? operationName,
    required Variables$Subscription$listen_or_courier_order_prices variables,
    graphql.FetchPolicy? fetchPolicy,
    graphql.ErrorPolicy? errorPolicy,
...
class FetchMoreOptions$Subscription$listen_or_courier_order_prices
    extends graphql.FetchMoreOptions {
  FetchMoreOptions$Subscription$listen_or_courier_order_prices({
    required graphql.UpdateQuery updateQuery,
    required Variables$Subscription$listen_or_courier_order_prices variables,
  }) : super(
          updateQuery: updateQuery,
...
extension ClientExtension$Subscription$listen_or_courier_order_prices
    on graphql.GraphQLClient {
  Stream<graphql.QueryResult<Subscription$listen_or_courier_order_prices>>
      subscribe$listen_or_courier_order_prices(
              Options$Subscription$listen_or_courier_order_prices options) =>
          this.subscribe(options);
  graphql.ObservableQuery<Subscription$listen_or_courier_order_prices>
      watchSubscription$listen_or_courier_order_prices(
              WatchOptions$Subscription$listen_or_courier_order_prices
                  options) =>
          this.watchQuery(options);
}

class Subscription$listen_or_courier_order_prices$delivery_courier_order {
  Subscription$listen_or_courier_order_prices$delivery_courier_order({
    this.total_cost,
    this.actual_items_cost,
    required this.refund_amount,
  ...
  factory Subscription$listen_or_courier_order_prices$delivery_courier_order.fromJson(
      Map<String, dynamic> json) {
    final l$total_cost = json['total_cost'];
    final l$actual_items_cost = json['actual_items_cost'];
    final l$refund_amount = json['refund_amount'];
    ...
    final l$delivery_order = json['delivery_order'];
    final l$$__typename = json['__typename'];
    return Subscription$listen_or_courier_order_prices$delivery_courier_order(
      total_cost: l$total_cost == null ? null : moneyFromJson(l$total_cost),
      actual_items_cost: l$actual_items_cost == null
          ? null
          : moneyFromJson(l$actual_items_cost),
      ...
      tax: moneyFromJson(l$tax),
      delivery_order:
          Subscription$listen_or_courier_order_prices$delivery_courier_order$delivery_order
              .fromJson((l$delivery_order as Map<String, dynamic>)),
      $__typename: ((l$$__typename ?? "none") as String),
    );
  }
  ...
  final Subscription$listen_or_courier_order_prices$delivery_courier_order$delivery_order
      delivery_order;
  ...
  bool operator ==(Object other) {
    ...
    if (!(other
            is Subscription$listen_or_courier_order_prices$delivery_courier_order) ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$total_cost = total_cost;
...
extension UtilityExtension$Subscription$listen_or_courier_order_prices$delivery_courier_order
    on Subscription$listen_or_courier_order_prices$delivery_courier_order {
  CopyWith$Subscription$listen_or_courier_order_prices$delivery_courier_order<
          Subscription$listen_or_courier_order_prices$delivery_courier_order>
      get copyWith =>
          CopyWith$Subscription$listen_or_courier_order_prices$delivery_courier_order(
...
abstract class CopyWith$Subscription$listen_or_courier_order_prices$delivery_courier_order<
    TRes> {
  factory CopyWith$Subscription$listen_or_courier_order_prices$delivery_courier_order(
    Subscription$listen_or_courier_order_prices$delivery_courier_order instance,
    TRes Function(
            Subscription$listen_or_courier_order_prices$delivery_courier_order)
        then,
  ) = _CopyWithImpl$Subscription$listen_or_courier_order_prices$delivery_courier_order;

  factory CopyWith$Subscription$listen_or_courier_order_prices$delivery_courier_order.stub(
          TRes res) =
      _CopyWithStubImpl$Subscription$listen_or_courier_order_prices$delivery_courier_order;
  ...
  CopyWith$Subscription$listen_or_courier_order_prices$delivery_courier_order$delivery_order<
      TRes> get delivery_order;
}

class _CopyWithImpl$Subscription$listen_or_courier_order_prices$delivery_courier_order<
        TRes>
    implements
        CopyWith$Subscription$listen_or_courier_order_prices$delivery_courier_order<
            TRes> {
  ...
  final Subscription$listen_or_courier_order_prices$delivery_courier_order
      _instance;

  final TRes Function(
      Subscription$listen_or_courier_order_prices$delivery_courier_order) _then;
  ...
  TRes call({
    ...
    Object? $__typename = _undefined,
      ...
      _then(Subscription$listen_or_courier_order_prices$delivery_courier_order(
        total_cost: total_cost == _undefined
            ? _instance.total_cost
            : (total_cost as double?),
        actual_items_cost: actual_items_cost == _undefined
        ...
        delivery_order: delivery_order == _undefined || delivery_order == null
            ? _instance.delivery_order
            : (delivery_order
                as Subscription$listen_or_courier_order_prices$delivery_courier_order$delivery_order),
        $__typename: $__typename == _undefined || $__typename == null
            ? _instance.$__typename
            : ($__typename as String),
      ));
  CopyWith$Subscription$listen_or_courier_order_prices$delivery_courier_order$delivery_order<
      TRes> get delivery_order {
    final local$delivery_order = _instance.delivery_order;
    return CopyWith$Subscription$listen_or_courier_order_prices$delivery_courier_order$delivery_order(
        local$delivery_order, (e) => call(delivery_order: e));
  }
}

class _CopyWithStubImpl$Subscription$listen_or_courier_order_prices$delivery_courier_order<
        TRes>
    implements
        CopyWith$Subscription$listen_or_courier_order_prices$delivery_courier_order<
            TRes> {
...
class Subscription$listen_or_courier_order_prices$delivery_courier_order$delivery_order {
  Subscription$listen_or_courier_order_prices$delivery_courier_order$delivery_order({
    required this.delivery_cost,
    required this.$__typename,
  });

  factory Subscription$listen_or_courier_order_prices$delivery_courier_order$delivery_order.fromJson(
      Map<String, dynamic> json) {
    final l$delivery_cost = json['delivery_cost'];
    final l$$__typename = json['__typename'];
    return Subscription$listen_or_courier_order_prices$delivery_courier_order$delivery_order(
      delivery_cost: moneyFromJson(l$delivery_cost),
      $__typename: ((l$$__typename ?? "none") as String),
    );
  }
  ...
  bool operator ==(Object other) {
    ...
    if (!(other
            is Subscription$listen_or_courier_order_prices$delivery_courier_order$delivery_order) ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$delivery_cost = delivery_cost;
...
extension UtilityExtension$Subscription$listen_or_courier_order_prices$delivery_courier_order$delivery_order
    on Subscription$listen_or_courier_order_prices$delivery_courier_order$delivery_order {
  CopyWith$Subscription$listen_or_courier_order_prices$delivery_courier_order$delivery_order<
          Subscription$listen_or_courier_order_prices$delivery_courier_order$delivery_order>
      get copyWith =>
          CopyWith$Subscription$listen_or_courier_order_prices$delivery_courier_order$delivery_order(
...
abstract class CopyWith$Subscription$listen_or_courier_order_prices$delivery_courier_order$delivery_order<
    TRes> {
  factory CopyWith$Subscription$listen_or_courier_order_prices$delivery_courier_order$delivery_order(
    Subscription$listen_or_courier_order_prices$delivery_courier_order$delivery_order
        instance,
    TRes Function(
            Subscription$listen_or_courier_order_prices$delivery_courier_order$delivery_order)
        then,
  ) = _CopyWithImpl$Subscription$listen_or_courier_order_prices$delivery_courier_order$delivery_order;

  factory CopyWith$Subscription$listen_or_courier_order_prices$delivery_courier_order$delivery_order.stub(
          TRes res) =
      _CopyWithStubImpl$Subscription$listen_or_courier_order_prices$delivery_courier_order$delivery_order;
...
class _CopyWithImpl$Subscription$listen_or_courier_order_prices$delivery_courier_order$delivery_order<
        TRes>
    implements
        CopyWith$Subscription$listen_or_courier_order_prices$delivery_courier_order$delivery_order<
            TRes> {
...
class _CopyWithStubImpl$Subscription$listen_or_courier_order_prices$delivery_courier_order$delivery_order<
        TRes>
    implements
        CopyWith$Subscription$listen_or_courier_order_prices$delivery_courier_order$delivery_order<
            TRes> {
...
class Variables$Query$get_courier_order_prices {
  factory Variables$Query$get_courier_order_prices({required int orderId}) =>
      Variables$Query$get_courier_order_prices._({
        r'orderId': orderId,
      });

  Variables$Query$get_courier_order_prices._(this._$data);

  factory Variables$Query$get_courier_order_prices.fromJson(
      Map<String, dynamic> data) {
    final result$data = <String, dynamic>{};
    final l$orderId = data['orderId'];
    result$data['orderId'] = (l$orderId as int);
    return Variables$Query$get_courier_order_prices._(result$data);
  }
  ...
  CopyWith$Variables$Query$get_courier_order_prices<
          Variables$Query$get_courier_order_prices>
      get copyWith => CopyWith$Variables$Query$get_courier_order_prices(
            this,
            (i) => i,
          );
  @override
  bool operator ==(Object other) {
    ...
    if (!(other is Variables$Query$get_courier_order_prices) ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$orderId = orderId;
...
abstract class CopyWith$Variables$Query$get_courier_order_prices<TRes> {
  factory CopyWith$Variables$Query$get_courier_order_prices(
    Variables$Query$get_courier_order_prices instance,
    TRes Function(Variables$Query$get_courier_order_prices) then,
  ) = _CopyWithImpl$Variables$Query$get_courier_order_prices;

  factory CopyWith$Variables$Query$get_courier_order_prices.stub(TRes res) =
      _CopyWithStubImpl$Variables$Query$get_courier_order_prices;

  TRes call({int? orderId});
}

class _CopyWithImpl$Variables$Query$get_courier_order_prices<TRes>
    implements CopyWith$Variables$Query$get_courier_order_prices<TRes> {
  _CopyWithImpl$Variables$Query$get_courier_order_prices(
    this._instance,
    this._then,
  );

  final Variables$Query$get_courier_order_prices _instance;

  final TRes Function(Variables$Query$get_courier_order_prices) _then;

  static const _undefined = {};

  TRes call({Object? orderId = _undefined}) =>
      _then(Variables$Query$get_courier_order_prices._({
        ..._instance._$data,
        if (orderId != _undefined && orderId != null)
          'orderId': (orderId as int),
      }));
...
class _CopyWithStubImpl$Variables$Query$get_courier_order_prices<TRes>
    implements CopyWith$Variables$Query$get_courier_order_prices<TRes> {
  _CopyWithStubImpl$Variables$Query$get_courier_order_prices(this._res);
...
class Query$get_courier_order_prices {
  Query$get_courier_order_prices({
    required this.delivery_courier_order,
    required this.$__typename,
  });

  factory Query$get_courier_order_prices.fromJson(Map<String, dynamic> json) {
    final l$delivery_courier_order = json['delivery_courier_order'];
    final l$$__typename = json['__typename'];
    return Query$get_courier_order_prices(
      delivery_courier_order: (l$delivery_courier_order as List<dynamic>)
          .map((e) =>
              Query$get_courier_order_prices$delivery_courier_order.fromJson(
  ...
  final List<Query$get_courier_order_prices$delivery_courier_order>
      delivery_courier_order;
  ...
  bool operator ==(Object other) {
    ...
    if (!(other is Query$get_courier_order_prices) ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$delivery_courier_order = delivery_courier_order;
...
extension UtilityExtension$Query$get_courier_order_prices
    on Query$get_courier_order_prices {
  CopyWith$Query$get_courier_order_prices<Query$get_courier_order_prices>
      get copyWith => CopyWith$Query$get_courier_order_prices(
            this,
            (i) => i,
          );
}

abstract class CopyWith$Query$get_courier_order_prices<TRes> {
  factory CopyWith$Query$get_courier_order_prices(
    Query$get_courier_order_prices instance,
    TRes Function(Query$get_courier_order_prices) then,
  ) = _CopyWithImpl$Query$get_courier_order_prices;

  factory CopyWith$Query$get_courier_order_prices.stub(TRes res) =
      _CopyWithStubImpl$Query$get_courier_order_prices;

  TRes call({
    List<Query$get_courier_order_prices$delivery_courier_order>?
        delivery_courier_order,
    String? $__typename,
  });
  TRes delivery_courier_order(
      Iterable<Query$get_courier_order_prices$delivery_courier_order> Function(
              Iterable<
                  CopyWith$Query$get_courier_order_prices$delivery_courier_order<
                      Query$get_courier_order_prices$delivery_courier_order>>)
          _fn);
}

class _CopyWithImpl$Query$get_courier_order_prices<TRes>
    implements CopyWith$Query$get_courier_order_prices<TRes> {
  _CopyWithImpl$Query$get_courier_order_prices(
    this._instance,
    this._then,
  );

  final Query$get_courier_order_prices _instance;

  final TRes Function(Query$get_courier_order_prices) _then;
  ...
  TRes call({
    ...
    Object? $__typename = _undefined,
      ...
      _then(Query$get_courier_order_prices(
        delivery_courier_order: delivery_courier_order == _undefined ||
                delivery_courier_order == null
            ? _instance.delivery_courier_order
            : (delivery_courier_order
                as List<Query$get_courier_order_prices$delivery_courier_order>),
        $__typename: $__typename == _undefined || $__typename == null
            ? _instance.$__typename
            : ($__typename as String),
      ));
...
class _CopyWithStubImpl$Query$get_courier_order_prices<TRes>
    implements CopyWith$Query$get_courier_order_prices<TRes> {
  _CopyWithStubImpl$Query$get_courier_order_prices(this._res);
...
const documentNodeQueryget_courier_order_prices = DocumentNode(definitions: [
  OperationDefinitionNode(
    type: OperationType.query,
    name: NameNode(value: 'get_courier_order_prices'),
    variableDefinitions: [
      VariableDefinitionNode(
        variable: VariableNode(name: NameNode(value: 'orderId')),
        type: NamedTypeNode(
...
Query$get_courier_order_prices _parserFn$Query$get_courier_order_prices(
        Map<String, dynamic> data) =>
    Query$get_courier_order_prices.fromJson(data);

class Options$Query$get_courier_order_prices
    extends graphql.QueryOptions<Query$get_courier_order_prices> {
  Options$Query$get_courier_order_prices({
    String? operationName,
    required Variables$Query$get_courier_order_prices variables,
    graphql.FetchPolicy? fetchPolicy,
    graphql.ErrorPolicy? errorPolicy,
    graphql.CacheRereadPolicy? cacheRereadPolicy,
    Object? optimisticResult,
    ...
    graphql.Context? context,
          ...
          pollInterval: pollInterval,
          context: context,
          document: documentNodeQueryget_courier_order_prices,
          parserFn: _parserFn$Query$get_courier_order_prices,
        );
}

class WatchOptions$Query$get_courier_order_prices
    extends graphql.WatchQueryOptions<Query$get_courier_order_prices> {
  WatchOptions$Query$get_courier_order_prices({
    String? operationName,
    required Variables$Query$get_courier_order_prices variables,
    graphql.FetchPolicy? fetchPolicy,
    graphql.ErrorPolicy? errorPolicy,
...
class FetchMoreOptions$Query$get_courier_order_prices
    extends graphql.FetchMoreOptions {
  FetchMoreOptions$Query$get_courier_order_prices({
    required graphql.UpdateQuery updateQuery,
    required Variables$Query$get_courier_order_prices variables,
  }) : super(
          updateQuery: updateQuery,
...
extension ClientExtension$Query$get_courier_order_prices
    on graphql.GraphQLClient {
  Future<graphql.QueryResult<Query$get_courier_order_prices>>
      query$get_courier_order_prices(
              Options$Query$get_courier_order_prices options) async =>
          await this.query(options);
  graphql.ObservableQuery<Query$get_courier_order_prices>
      watchQuery$get_courier_order_prices(
              WatchOptions$Query$get_courier_order_prices options) =>
          this.watchQuery(options);
  void writeQuery$get_courier_order_prices({
    required Query$get_courier_order_prices data,
    required Variables$Query$get_courier_order_prices variables,
    bool broadcast = true,
  }) =>
      this.writeQuery(
  ...
  Query$get_courier_order_prices? readQuery$get_courier_order_prices({
    required Variables$Query$get_courier_order_prices variables,
    bool optimistic = true,
  }) {
    final result = this.readQuery(
    ...
    return result == null
        ? null
        : Query$get_courier_order_prices.fromJson(result);
  }
}

class Query$get_courier_order_prices$delivery_courier_order {
  Query$get_courier_order_prices$delivery_courier_order({
    this.total_cost,
    this.actual_items_cost,
    required this.refund_amount,
  ...
  factory Query$get_courier_order_prices$delivery_courier_order.fromJson(
      Map<String, dynamic> json) {
    final l$total_cost = json['total_cost'];
    final l$actual_items_cost = json['actual_items_cost'];
    final l$refund_amount = json['refund_amount'];
    ...
    final l$delivery_order = json['delivery_order'];
    final l$$__typename = json['__typename'];
    return Query$get_courier_order_prices$delivery_courier_order(
      total_cost: l$total_cost == null ? null : moneyFromJson(l$total_cost),
      actual_items_cost: l$actual_items_cost == null
          ? null
          : moneyFromJson(l$actual_items_cost),
      ...
      tax: moneyFromJson(l$tax),
      delivery_order:
          Query$get_courier_order_prices$delivery_courier_order$delivery_order
              .fromJson((l$delivery_order as Map<String, dynamic>)),
      $__typename: ((l$$__typename ?? "none") as String),
    );
  }
  ...
  final Query$get_courier_order_prices$delivery_courier_order$delivery_order
      delivery_order;
  ...
  bool operator ==(Object other) {
    ...
    if (!(other is Query$get_courier_order_prices$delivery_courier_order) ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$total_cost = total_cost;
...
extension UtilityExtension$Query$get_courier_order_prices$delivery_courier_order
    on Query$get_courier_order_prices$delivery_courier_order {
  CopyWith$Query$get_courier_order_prices$delivery_courier_order<
          Query$get_courier_order_prices$delivery_courier_order>
      get copyWith =>
          CopyWith$Query$get_courier_order_prices$delivery_courier_order(
...
abstract class CopyWith$Query$get_courier_order_prices$delivery_courier_order<
    TRes> {
  factory CopyWith$Query$get_courier_order_prices$delivery_courier_order(
    Query$get_courier_order_prices$delivery_courier_order instance,
    TRes Function(Query$get_courier_order_prices$delivery_courier_order) then,
  ) = _CopyWithImpl$Query$get_courier_order_prices$delivery_courier_order;

  factory CopyWith$Query$get_courier_order_prices$delivery_courier_order.stub(
          TRes res) =
      _CopyWithStubImpl$Query$get_courier_order_prices$delivery_courier_order;
  ...
  CopyWith$Query$get_courier_order_prices$delivery_courier_order$delivery_order<
      TRes> get delivery_order;
}

class _CopyWithImpl$Query$get_courier_order_prices$delivery_courier_order<TRes>
    implements
        CopyWith$Query$get_courier_order_prices$delivery_courier_order<TRes> {
  _CopyWithImpl$Query$get_courier_order_prices$delivery_courier_order(
    this._instance,
    this._then,
  );

  final Query$get_courier_order_prices$delivery_courier_order _instance;

  final TRes Function(Query$get_courier_order_prices$delivery_courier_order)
      _then;
  ...
  TRes call({
    ...
    Object? $__typename = _undefined,
      ...
      _then(Query$get_courier_order_prices$delivery_courier_order(
        total_cost: total_cost == _undefined
            ? _instance.total_cost
            : (total_cost as double?),
        actual_items_cost: actual_items_cost == _undefined
        ...
        delivery_order: delivery_order == _undefined || delivery_order == null
            ? _instance.delivery_order
            : (delivery_order
                as Query$get_courier_order_prices$delivery_courier_order$delivery_order),
        $__typename: $__typename == _undefined || $__typename == null
            ? _instance.$__typename
            : ($__typename as String),
      ));
  CopyWith$Query$get_courier_order_prices$delivery_courier_order$delivery_order<
      TRes> get delivery_order {
    final local$delivery_order = _instance.delivery_order;
    return CopyWith$Query$get_courier_order_prices$delivery_courier_order$delivery_order(
        local$delivery_order, (e) => call(delivery_order: e));
  }
}

class _CopyWithStubImpl$Query$get_courier_order_prices$delivery_courier_order<
        TRes>
    implements
        CopyWith$Query$get_courier_order_prices$delivery_courier_order<TRes> {
  _CopyWithStubImpl$Query$get_courier_order_prices$delivery_courier_order(
...
class Query$get_courier_order_prices$delivery_courier_order$delivery_order {
  Query$get_courier_order_prices$delivery_courier_order$delivery_order({
    required this.delivery_cost,
    required this.$__typename,
  });

  factory Query$get_courier_order_prices$delivery_courier_order$delivery_order.fromJson(
      Map<String, dynamic> json) {
    final l$delivery_cost = json['delivery_cost'];
    final l$$__typename = json['__typename'];
    return Query$get_courier_order_prices$delivery_courier_order$delivery_order(
      delivery_cost: moneyFromJson(l$delivery_cost),
      $__typename: ((l$$__typename ?? "none") as String),
    );
  }
  ...
  bool operator ==(Object other) {
    ...
    if (!(other
            is Query$get_courier_order_prices$delivery_courier_order$delivery_order) ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$delivery_cost = delivery_cost;
...
extension UtilityExtension$Query$get_courier_order_prices$delivery_courier_order$delivery_order
    on Query$get_courier_order_prices$delivery_courier_order$delivery_order {
  CopyWith$Query$get_courier_order_prices$delivery_courier_order$delivery_order<
          Query$get_courier_order_prices$delivery_courier_order$delivery_order>
      get copyWith =>
          CopyWith$Query$get_courier_order_prices$delivery_courier_order$delivery_order(
...
abstract class CopyWith$Query$get_courier_order_prices$delivery_courier_order$delivery_order<
    TRes> {
  factory CopyWith$Query$get_courier_order_prices$delivery_courier_order$delivery_order(
    Query$get_courier_order_prices$delivery_courier_order$delivery_order
        instance,
    TRes Function(
            Query$get_courier_order_prices$delivery_courier_order$delivery_order)
        then,
  ) = _CopyWithImpl$Query$get_courier_order_prices$delivery_courier_order$delivery_order;

  factory CopyWith$Query$get_courier_order_prices$delivery_courier_order$delivery_order.stub(
          TRes res) =
      _CopyWithStubImpl$Query$get_courier_order_prices$delivery_courier_order$delivery_order;
...
class _CopyWithImpl$Query$get_courier_order_prices$delivery_courier_order$delivery_order<
        TRes>
    implements
        CopyWith$Query$get_courier_order_prices$delivery_courier_order$delivery_order<
            TRes> {
...
class _CopyWithStubImpl$Query$get_courier_order_prices$delivery_courier_order$delivery_order<
        TRes>
    implements
        CopyWith$Query$get_courier_order_prices$delivery_courier_order$delivery_order<
            TRes> {
