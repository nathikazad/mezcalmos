...
class MyPopupMenuController extends ChangeNotifier {
...
class _MyPopupMenuState extends State<MyPopupMenu>
  ...
  MyPopupMenuController? _controller;
                            ...
                            children: <Widget>[
                              Material(
                                child: AnimatedBuilder(
                                  animation: _animatedController.view,
  ...
  void initState() {
    ...
    if (widget.controller!.menuIsShowing) _animatedController.value = 1.0;
