          ...
          children: <Widget>[
            ...
            Text.rich(
              TextSpan(children: <InlineSpan>[
                ...
                TextSpan(
                    text:
                        "${_i18n()['discountLabel']} : ${earning.discount.toPriceString()}"),
              ]),
            ),
            Text.rich(
              TextSpan(children: <InlineSpan>[
                ...
                TextSpan(
                  text:
                      "${_i18n()['orderTotalLabel']} : ${earning.totalBeforeDiscount.toPriceString()} - (${earning.discount.toPriceString()}) = ${earning.orderTotal.toPriceString()}",
                ),
              ]),
            ),
            Text.rich(
              TextSpan(children: <InlineSpan>[
                ...
                TextSpan(
                  text:
                      "${earning.influencerOfferDetails.toReadableString} = ${earning.comission.toPriceString()}",
                ),
              ]),
            ),
          ],
