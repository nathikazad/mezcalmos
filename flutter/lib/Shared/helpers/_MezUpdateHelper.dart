...
//   static Future<MezAppUpdateInfo> mezCheckForUpdate({
//     required String packageName,
//   }) async {
//     final result = await _channel.invokeMethod('checkForUpdate');

//     return MezAppUpdateInfo(
...
//   static Future<MezAppUpdateResult> performImmediateUpdate() async {
//     try {
//       await _channel.invokeMethod('performImmediateUpdate');
//       return MezAppUpdateResult.success;
//     } on PlatformException catch (e) {
//       if (e.code == 'USER_DENIED_UPDATE') {
//         return MezAppUpdateResult.userDeniedUpdate;
//       } else if (e.code == 'IN_APP_UPDATE_FAILED') {
//         return MezAppUpdateResult.inAppUpdateFailed;
//       }
...
//   ///
//   /// [checkForUpdate] has to be called first to be able to run this.
//   static Future<MezAppUpdateResult> startFlexibleUpdate() async {
//     try {
