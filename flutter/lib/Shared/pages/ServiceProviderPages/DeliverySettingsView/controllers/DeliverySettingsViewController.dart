...
class DeliverySettingsViewController {
  ...
  Future<void> _initEditMode(
    ...
    if (serviceProviderType != ServiceProviderType.DeliveryCompany) {
      ...
      if (deliveryCost.value != null) {
        deliveryAvailable.value = deliveryCost.value!.deliveryAvailable;
        customerPickupAvailable.value = deliveryCost.value!.pickupAvailable;
        sitInAvailable.value = deliveryCost.value!.sitInAvailable;
      }
  ...
  bool get hasData {
    if (serviceProviderId != null && serviceProviderType != null) {
      return (deliveryCost.value != null
          // || deliveryPartnerId.value != null
          );
    } else
      return true;
  }
  ...
  void switchSitin(bool v) {
    sitInAvailable.value = v;
  }

  void switchPickup(bool v) {
    customerPickupAvailable.value = v;
  }

  void switchDelivery(bool v) {
    deliveryAvailable.value = v;
  }
}
