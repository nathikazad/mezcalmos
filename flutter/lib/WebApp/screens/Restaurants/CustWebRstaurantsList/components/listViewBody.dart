...
import 'package:mezcalmos/WebApp/screens/Restaurants/CustWebRstaurantsList/components/restaurantCardForMobile.dart';
...
class ListRestauBody extends StatefulWidget {
  ...
  final CustRestaurantListViewController viewController;
...
class _ListRestauBodyState extends State<ListRestauBody> {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
        ...
        child: Column(
          children: [
            _searchInput(context, viewController: widget.viewController),
            _searchFilter(),
            _sortingSwitcher(),
            Obx(() {
  ...
  Widget _searchInput(BuildContext context,
      {required CustRestaurantListViewController viewController}) {
