...
class CustWebRestaurantView extends StatefulWidget {
  CustWebRestaurantView({Key? key}) : super(key: key);

  @override
  State<CustWebRestaurantView> createState() => _CustWebRestaurantViewState();
}

class _CustWebRestaurantViewState extends State<CustWebRestaurantView> {
