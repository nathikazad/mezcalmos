...
class OrderViewScreenForMobile extends StatefulWidget {
  OrderViewScreenForMobile({
    Key? key,
  }) : super(key: key);

  @override
  State<OrderViewScreenForMobile> createState() =>
      _OrderViewScreenForMobileState();
}

class _OrderViewScreenForMobileState extends State<OrderViewScreenForMobile> {
  ...
  @override
  void didUpdateWidget(OrderViewScreenForMobile oldWidget) {
    final String orderId = QR.params['orderId'].toString();
