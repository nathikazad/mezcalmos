...
/// [MezExpansionTile] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
...
/// to the [leading] and [trailing] properties of [MezExpansionTile].
///
/// {@tool dartpad}
...
class MezExpansionTile extends StatefulWidget {
  /// Creates a single-line [ListTile] with an expansion arrow icon that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const MezExpansionTile({
    Key? key,
    this.leading,
    required this.title,
    this.subtitle,
  ...
  @override
  State<MezExpansionTile> createState() => _MezExpansionTileState();
}

class _MezExpansionTileState extends State<MezExpansionTile>
