...
import 'package:mezcalmos/DeliveryAdminApp.old/pages/AddServiceViews/Controllers/AddLaundryServiceViewController.dart';
...
class _AddLaundryServiceViewState extends State<AddRestaurantServiceView> {
  ...
  @override
  void initState() {
    viewController.init(serviceType: ServiceProviderType.Restaurant);
    super.initState();
  }
