  ...
  void onInit() {
    currentOrders.value = [
      ...
      FakeOrder(
        ...
        cost: 12,
        serviceProviderId: 'serviceID',
        serviceProvider: UserInfo('id', 'Laundry name',
            'https://i.pinimg.com/736x/4e/74/6f/4e746f663f7ef3a864a39ef8fcb63721.jpg'),
        customer: UserInfo('id', 'Customer name',
            'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Pierre-Person.jpg/1200px-Pierre-Person.jpg'),
        orderTime: DateTime.now(),
