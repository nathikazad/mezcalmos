...
class BsOpSchedulePickerWidgets {
  final BsOpSchedulePickerViewController viewController;
  final BuildContext context;
  BsOpSchedulePickerWidgets(
...
// BOTTOM SHEET CONTENT //
  ...
  Widget _cancelBtn() {
    return TextButton(
        ...
        onPressed: () {
          Future.delayed(Duration.zero, MezRouter.back).then((bool value) {
            viewController.schedulePreview.value =
