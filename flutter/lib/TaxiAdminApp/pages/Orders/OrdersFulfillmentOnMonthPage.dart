...
List<charts.Series<NbOrders, String>> _createSampleData(
  ...
  var newOrdersData = <NbOrders>[];
  data.forEach((key, value) {
    newOrdersData
        .add(new NbOrders(key.toString(), int.parse(value.toString())));
  });
  ...
  return [
    new charts.Series<NbOrders, String>(
      ...
      id: 'Expered',
      domainFn: (NbOrders order, _) => order.day.toString(),
      measureFn: (NbOrders order, _) => order.nbOrders,
      data: newOrdersData,
    ),
  ];
}
