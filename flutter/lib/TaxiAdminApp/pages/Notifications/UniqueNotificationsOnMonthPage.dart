...
class UniqueNotificationsOnMonthPage extends GetView<NotificationsController> {
  ...
  var dayValue = 0.obs;
  Widget getUniqueNotificationForMonth(BuildContext context) {
    return getFutureData(
        controller.getUniqueNotificationForMonth(selectedtime.value.month),
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    child: Text(
                      "${data["byDay"][DateTime.now().day]["uniqueSent"]}",
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(18)),
                    child: Text(
                      "${data["byDay"][DateTime.now().day]["uniqueRead"]}",
                      textAlign: TextAlign.center,
                      style: TextStyle(
                          color: Colors.white,
                          fontSize: 16,
                ...
                children: [
                  Container(
                    ...
                    child: Obx(
                      () => Text(
                        (dayValue.value != 0)
                            ? "${data["byDay"][dayValue.value]["uniqueSent"]}"
                            : "0",
                        textAlign: TextAlign.center,
                        style: TextStyle(
                            color: Colors.white,
                  ...
                  Container(
                    ...
                    child: Obx(
                      () => Text(
                        (dayValue.value != 0)
                            ? "${data["byDay"][dayValue.value]["uniqueRead"]}"
                            : "0",
                        textAlign: TextAlign.center,
                        style: TextStyle(
                            color: Colors.white,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: GetX<NotificationsController>(
            ...
            builder: (controller) {
              return Container(child: getUniqueNotificationForMonth(context));
            }));
  }
}
...
List<charts.Series<NbNotifs, String>> _createSampleData(
  ...
  var uniqueSentData = <NbNotifs>[];
  var uniqueReadData = <NbNotifs>[];
  data.forEach((key, value) {
    //print(data[key][]);
    uniqueSentData.add(new NbNotifs(
        key.toString(), int.parse(value["uniqueSent"].toString())));
    uniqueReadData.add(new NbNotifs(
        key.toString(), int.parse(value["uniqueRead"].toString())));
  });
