...
import 'package:mezcalmos/DeliveryAdminApp/pages/Orders/LaundryOrder/Components/OderCategoryBottomModal.dart';
  ...
  Widget setItemsWeightButton(BuildContext context) {
    return TextButton(
        ...
        style: TextButton.styleFrom(
            backgroundColor: !order.isAtLaundry() ? Colors.grey : purpleColor),
        child: Container(
