...
import 'package:mezcalmos/CustomerApp/pages/DeliveryServices/Laundry/LaundryCurrentOrderView/components/LaundryOrderStatusCard.dart';
import 'package:mezcalmos/CustomerApp/pages/DeliveryServices/Laundry/LaundryCurrentOrderView/components/OrderLaundryCard.dart';
import 'package:mezcalmos/CustomerApp/pages/DeliveryServices/Laundry/LaundryCurrentOrderView/controllers/CustLaundryOrderViewController.dart';
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            if (viewController.order.value?.getDriverByPhase ==
                                null)
                            ...
                            OrderSummaryCard(
                              ...
                              costs: viewController.order.value!.isItemsPriceSet
                                  ? viewController.order.value!.costs
                                  : OrderCosts(
                                      deliveryCost: viewController
                                          .order.value!.costs.deliveryCost,
                                      refundAmmount: viewController
                                          .order.value!.costs.refundAmmount,
                                      tax:
                                          viewController.order.value!.costs.tax,
                                      orderItemsCost: null,
                                      totalCost: null),
