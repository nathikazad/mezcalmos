...
class CustServiceListViewController {
  ...
  List<ServiceCategory1> get serviceCategory => _currentRentalCategory;

  late List<ServiceCategory1> _currentRentalCategory;

// methods //
  Future<void> init({required ServiceCategory1 serviceCategory}) async {
    _currentRentalCategory = [serviceCategory];
