...
List<Widget> choosenOneOption(Map<String, String> data, BuildContext context) {
  ...
  data.keys.forEach((oneOptionKey) {
    myWidgets.addAll([
      // title aka Id FIRST
      MenuTitles(
          title: oneOptionKey.capitalizeFirst,
      ...
      Container(
        ...
        child: Text(
            // oneOption.name
            data[oneOptionKey].toString().inCaps,
            style: TextStyle(
